...
M.setup = function()
  map("n", "<leader>jl", "<cmd> :Telescope projects <CR>")
  map("n", "<leader>jj", "<cmd> :Telescope find_files <CR>")
  map("n", "<leader>jo", "<cmd> :Telescope oldfiles <CR>")

  map("n", "<leader>jk", "<cmd> :Telescope live_grep <CR>")

  map("n", "<leader>jt", "<cmd> :Telescope help_tags <CR>")
  map("n", "<leader>jc", "<cmd> :Telescope commands <CR>")
  map("n", "<leader>jh", "<cmd> :Telescope search_history <CR>")
  map("n", "<leader>jm", "<cmd> :Telescope keymaps <CR>")
  map("n", "<leader>jv", "<cmd> :Telescope vim_options <CR>")
